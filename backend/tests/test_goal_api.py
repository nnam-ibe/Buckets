...
class GoalViewSetTestCase(APITestCase):
    ...
    def test_create_goal(self):
        ...
        response = self.client.post('/api/goal/', payload, format='json', **self.header_token)
    ...
    def test_patch_goal(self):
        ...
        for goal in user_goals:
            ...
            response = self.client.patch(f'/api/goal/{goal.id}/', payload, format='json', **self.header_token)
            self.assertEqual(response.status_code, HTTPStatus.OK._value_)
    ...
    def test_put_goal(self):
        ...
        for goal in user_goals:
            ...
            response = self.client.put(f'/api/goal/{goal.id}/', payload, format='json', **self.header_token)
            self.assertEqual(response.status_code, HTTPStatus.OK._value_)
            self.assertEqual(response.data['id'], goal.id)
            self.assertEqual(response.data['name'], payload['name'])
