...
class AuthenticationAPITestCase(APITestCase):
    ...
    def test_get_user_via_token(self):
        ...
        response = self.client.get('/api/auth/user', format='json', HTTP_AUTHORIZATION=f'Token {token}')
        self.assertEqual(response.status_code, HTTPStatus.OK._value_)
    ...
    def test_user_logout(self):
        ...
        response = self.client.post('/api/auth/logout', format='json', HTTP_AUTHORIZATION=f'Token {token}')
